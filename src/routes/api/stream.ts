          ...
          <head>
            ...
            <style>
              ...
              body {
                ...
                background: #333;
                font-size: 1.5em;
                padding: 2em; /* Reducir el relleno para dispositivos más pequeños */
                display: flex;
              ...
              p {
                max-width: 1200px; /* Ajustar el ancho máximo del texto para evitar líneas extremadamente largas */
              ...
              @media only screen and (max-width: 860px) {
                body {
                  font-size: 1.2em; /* Reducir el tamaño del texto para dispositivos más pequeños */
                  padding: 1em;
                }
                h1 {
                  font-size: 1.7em;
